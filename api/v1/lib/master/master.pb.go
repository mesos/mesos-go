...
type Call_UpdateQuota struct {
	QuotaRequests []mesos_quota.QuotaRequest `protobuf:"bytes,1,rep,name=quota_requests,json=quotaRequests" json:"quota_requests"`
}
...
func (m *Call_UpdateQuota) GetQuotaRequests() []mesos_quota.QuotaRequest {
	if m != nil {
...
func (this *Call_UpdateQuota) VerboseEqual(that interface{}) error {
	...
	if len(this.QuotaRequests) != len(that1.QuotaRequests) {
		return fmt.Errorf("QuotaRequests this(%v) Not Equal that(%v)", len(this.QuotaRequests), len(that1.QuotaRequests))
	}
	for i := range this.QuotaRequests {
		if !this.QuotaRequests[i].Equal(&that1.QuotaRequests[i]) {
			return fmt.Errorf("QuotaRequests this[%v](%v) Not Equal that[%v](%v)", i, this.QuotaRequests[i], i, that1.QuotaRequests[i])
		}
	}
	return nil
}
...
func (this *Call_UpdateQuota) GoString() string {
	...
	if this.QuotaRequests != nil {
		s = append(s, "QuotaRequests: "+fmt.Sprintf("%#v", this.QuotaRequests)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Call_UpdateQuota) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.QuotaRequests) > 0 {
		for _, msg := range m.QuotaRequests {
			dAtA[i] = 0xa
			i++
			i = encodeVarintMaster(dAtA, i, uint64(msg.ProtoSize()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func NewPopulatedCall_UpdateQuota(r randyMaster, easy bool) *Call_UpdateQuota {
	...
	if r.Intn(10) != 0 {
		v26 := r.Intn(5)
		this.QuotaRequests = make([]mesos_quota.QuotaRequest, v26)
		for i := 0; i < v26; i++ {
			v27 := mesos_quota.NewPopulatedQuotaRequest(r, easy)
			this.QuotaRequests[i] = *v27
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedCall_SetQuota(r randyMaster, easy bool) *Call_SetQuota {
	this := &Call_SetQuota{}
	v28 := mesos_quota.NewPopulatedQuotaRequest(r, easy)
	this.QuotaRequest = *v28
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedCall_Teardown(r randyMaster, easy bool) *Call_Teardown {
	this := &Call_Teardown{}
	v29 := mesos.NewPopulatedFrameworkID(r, easy)
	this.FrameworkID = *v29
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedResponse_GetFlags(r randyMaster, easy bool) *Response_GetFlags {
	...
	if r.Intn(10) != 0 {
		v31 := r.Intn(5)
		this.Flags = make([]mesos.Flag, v31)
		for i := 0; i < v31; i++ {
			v32 := mesos.NewPopulatedFlag(r, easy)
			this.Flags[i] = *v32
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedResponse_GetVersion(r randyMaster, easy bool) *Response_GetVersion {
	...
	v33 := mesos.NewPopulatedVersionInfo(r, easy)
	this.VersionInfo = *v33
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedResponse_GetMetrics(r randyMaster, easy bool) *Response_GetMetrics {
	...
	if r.Intn(10) != 0 {
		v34 := r.Intn(5)
		this.Metrics = make([]mesos.Metric, v34)
		for i := 0; i < v34; i++ {
			v35 := mesos.NewPopulatedMetric(r, easy)
			this.Metrics[i] = *v35
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedResponse_ListFiles(r randyMaster, easy bool) *Response_ListFiles {
	...
	if r.Intn(10) != 0 {
		v36 := r.Intn(5)
		this.FileInfos = make([]mesos.FileInfo, v36)
		for i := 0; i < v36; i++ {
			v37 := mesos.NewPopulatedFileInfo(r, easy)
			this.FileInfos[i] = *v37
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetAgents(r randyMaster, easy bool) *Response_GetAgents {
	...
	if r.Intn(10) != 0 {
		v39 := r.Intn(5)
		this.Agents = make([]Response_GetAgents_Agent, v39)
		for i := 0; i < v39; i++ {
			v40 := NewPopulatedResponse_GetAgents_Agent(r, easy)
			this.Agents[i] = *v40
		}
	}
	if r.Intn(10) != 0 {
		v41 := r.Intn(5)
		this.RecoveredAgents = make([]mesos.AgentInfo, v41)
		for i := 0; i < v41; i++ {
			v42 := mesos.NewPopulatedAgentInfo(r, easy)
			this.RecoveredAgents[i] = *v42
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetAgents_Agent(r randyMaster, easy bool) *Response_GetAgents_Agent {
	...
	if r.Intn(10) != 0 {
		v45 := r.Intn(5)
		this.TotalResources = make([]mesos.Resource, v45)
		for i := 0; i < v45; i++ {
			v46 := mesos.NewPopulatedResource(r, easy)
			this.TotalResources[i] = *v46
		}
	}
	if r.Intn(10) != 0 {
		v47 := r.Intn(5)
		this.AllocatedResources = make([]mesos.Resource, v47)
		for i := 0; i < v47; i++ {
			v48 := mesos.NewPopulatedResource(r, easy)
			this.AllocatedResources[i] = *v48
		}
	}
	if r.Intn(10) != 0 {
		v49 := r.Intn(5)
		this.OfferedResources = make([]mesos.Resource, v49)
		for i := 0; i < v49; i++ {
			v50 := mesos.NewPopulatedResource(r, easy)
			this.OfferedResources[i] = *v50
		}
	}
	if r.Intn(10) != 0 {
		v51 := r.Intn(5)
		this.Capabilities = make([]mesos.AgentInfo_Capability, v51)
		for i := 0; i < v51; i++ {
			v52 := mesos.NewPopulatedAgentInfo_Capability(r, easy)
			this.Capabilities[i] = *v52
		}
	}
	if r.Intn(10) != 0 {
		v53 := r.Intn(5)
		this.ResourceProviders = make([]Response_GetAgents_Agent_ResourceProvider, v53)
		for i := 0; i < v53; i++ {
			v54 := NewPopulatedResponse_GetAgents_Agent_ResourceProvider(r, easy)
			this.ResourceProviders[i] = *v54
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetAgents_Agent_ResourceProvider(r randyMaster, easy bool) *Response_GetAgents_Agent_ResourceProvider {
	...
	v55 := mesos.NewPopulatedResourceProviderInfo(r, easy)
	this.ResourceProviderInfo = *v55
	if r.Intn(10) != 0 {
		v56 := r.Intn(5)
		this.TotalResources = make([]mesos.Resource, v56)
		for i := 0; i < v56; i++ {
			v57 := mesos.NewPopulatedResource(r, easy)
			this.TotalResources[i] = *v57
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetFrameworks(r randyMaster, easy bool) *Response_GetFrameworks {
	...
	if r.Intn(10) != 0 {
		v58 := r.Intn(5)
		this.Frameworks = make([]Response_GetFrameworks_Framework, v58)
		for i := 0; i < v58; i++ {
			v59 := NewPopulatedResponse_GetFrameworks_Framework(r, easy)
			this.Frameworks[i] = *v59
		}
	}
	if r.Intn(10) != 0 {
		v60 := r.Intn(5)
		this.CompletedFrameworks = make([]Response_GetFrameworks_Framework, v60)
		for i := 0; i < v60; i++ {
			v61 := NewPopulatedResponse_GetFrameworks_Framework(r, easy)
			this.CompletedFrameworks[i] = *v61
		}
	}
	if r.Intn(10) != 0 {
		v62 := r.Intn(5)
		this.RecoveredFrameworks = make([]mesos.FrameworkInfo, v62)
		for i := 0; i < v62; i++ {
			v63 := mesos.NewPopulatedFrameworkInfo(r, easy)
			this.RecoveredFrameworks[i] = *v63
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetFrameworks_Framework(r randyMaster, easy bool) *Response_GetFrameworks_Framework {
	...
	if r.Intn(10) != 0 {
		v65 := r.Intn(5)
		this.Offers = make([]mesos.Offer, v65)
		for i := 0; i < v65; i++ {
			v66 := mesos.NewPopulatedOffer(r, easy)
			this.Offers[i] = *v66
		}
	}
	if r.Intn(10) != 0 {
		v67 := r.Intn(5)
		this.InverseOffers = make([]mesos.InverseOffer, v67)
		for i := 0; i < v67; i++ {
			v68 := mesos.NewPopulatedInverseOffer(r, easy)
			this.InverseOffers[i] = *v68
		}
	}
	if r.Intn(10) != 0 {
		v69 := r.Intn(5)
		this.AllocatedResources = make([]mesos.Resource, v69)
		for i := 0; i < v69; i++ {
			v70 := mesos.NewPopulatedResource(r, easy)
			this.AllocatedResources[i] = *v70
		}
	}
	if r.Intn(10) != 0 {
		v71 := r.Intn(5)
		this.OfferedResources = make([]mesos.Resource, v71)
		for i := 0; i < v71; i++ {
			v72 := mesos.NewPopulatedResource(r, easy)
			this.OfferedResources[i] = *v72
		}
	}
...
func NewPopulatedResponse_GetExecutors(r randyMaster, easy bool) *Response_GetExecutors {
	...
	if r.Intn(10) != 0 {
		v73 := r.Intn(5)
		this.Executors = make([]Response_GetExecutors_Executor, v73)
		for i := 0; i < v73; i++ {
			v74 := NewPopulatedResponse_GetExecutors_Executor(r, easy)
			this.Executors[i] = *v74
		}
	}
	if r.Intn(10) != 0 {
		v75 := r.Intn(5)
		this.OrphanExecutors = make([]Response_GetExecutors_Executor, v75)
		for i := 0; i < v75; i++ {
			v76 := NewPopulatedResponse_GetExecutors_Executor(r, easy)
			this.OrphanExecutors[i] = *v76
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetExecutors_Executor(r randyMaster, easy bool) *Response_GetExecutors_Executor {
	...
	v77 := mesos.NewPopulatedExecutorInfo(r, easy)
	this.ExecutorInfo = *v77
	v78 := mesos.NewPopulatedAgentID(r, easy)
	this.AgentID = *v78
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedResponse_GetOperations(r randyMaster, easy bool) *Response_GetOperations {
	...
	if r.Intn(10) != 0 {
		v79 := r.Intn(5)
		this.Operations = make([]mesos.Operation, v79)
		for i := 0; i < v79; i++ {
			v80 := mesos.NewPopulatedOperation(r, easy)
			this.Operations[i] = *v80
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetTasks(r randyMaster, easy bool) *Response_GetTasks {
	...
	if r.Intn(10) == 0 {
		v81 := r.Intn(5)
		this.PendingTasks = make([]mesos.Task, v81)
		for i := 0; i < v81; i++ {
			v82 := mesos.NewPopulatedTask(r, easy)
			this.PendingTasks[i] = *v82
		}
	}
	if r.Intn(10) == 0 {
		v83 := r.Intn(5)
		this.Tasks = make([]mesos.Task, v83)
		for i := 0; i < v83; i++ {
	...
	if r.Intn(10) == 0 {
		v85 := r.Intn(5)
		this.CompletedTasks = make([]mesos.Task, v85)
		for i := 0; i < v85; i++ {
			v86 := mesos.NewPopulatedTask(r, easy)
			this.CompletedTasks[i] = *v86
		}
	}
	if r.Intn(10) == 0 {
		v87 := r.Intn(5)
		this.OrphanTasks = make([]mesos.Task, v87)
		for i := 0; i < v87; i++ {
			v88 := mesos.NewPopulatedTask(r, easy)
			this.OrphanTasks[i] = *v88
		}
	}
	if r.Intn(10) == 0 {
		v89 := r.Intn(5)
		this.UnreachableTasks = make([]mesos.Task, v89)
		for i := 0; i < v89; i++ {
			v90 := mesos.NewPopulatedTask(r, easy)
			this.UnreachableTasks[i] = *v90
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetRoles(r randyMaster, easy bool) *Response_GetRoles {
	...
	if r.Intn(10) != 0 {
		v91 := r.Intn(5)
		this.Roles = make([]mesos.Role, v91)
		for i := 0; i < v91; i++ {
			v92 := mesos.NewPopulatedRole(r, easy)
			this.Roles[i] = *v92
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedResponse_GetWeights(r randyMaster, easy bool) *Response_GetWeights {
	...
	if r.Intn(10) != 0 {
		v93 := r.Intn(5)
		this.WeightInfos = make([]mesos.WeightInfo, v93)
		for i := 0; i < v93; i++ {
			v94 := mesos.NewPopulatedWeightInfo(r, easy)
			this.WeightInfos[i] = *v94
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetMaintenanceStatus(r randyMaster, easy bool) *Response_GetMaintenanceStatus {
	...
	v97 := mesos_maintenance.NewPopulatedClusterStatus(r, easy)
	this.Status = *v97
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedResponse_GetMaintenanceSchedule(r randyMaster, easy bool) *Response_GetMaintenanceSchedule {
	...
	v98 := mesos_maintenance.NewPopulatedSchedule(r, easy)
	this.Schedule = *v98
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedResponse_GetQuota(r randyMaster, easy bool) *Response_GetQuota {
	...
	v99 := mesos_quota.NewPopulatedQuotaStatus(r, easy)
	this.Status = *v99
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedEvent_Subscribed(r randyMaster, easy bool) *Event_Subscribed {
	...
	if r.Intn(10) != 0 {
		v100 := float64(r.Float64())
		if r.Intn(2) == 0 {
			v100 *= -1
		}
		this.HeartbeatIntervalSeconds = &v100
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedEvent_TaskAdded(r randyMaster, easy bool) *Event_TaskAdded {
	...
	v101 := mesos.NewPopulatedTask(r, easy)
	this.Task = *v101
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedEvent_TaskUpdated(r randyMaster, easy bool) *Event_TaskUpdated {
	...
	v102 := mesos.NewPopulatedFrameworkID(r, easy)
	this.FrameworkID = *v102
	v103 := mesos.NewPopulatedTaskStatus(r, easy)
	this.Status = *v103
	v104 := mesos.TaskState([]int32{6, 0, 1, 8, 2, 3, 4, 7, 5, 9, 10, 11, 12, 13}[r.Intn(14)])
	this.State = &v104
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedEvent_FrameworkAdded(r randyMaster, easy bool) *Event_FrameworkAdded {
	...
	v105 := NewPopulatedResponse_GetFrameworks_Framework(r, easy)
	this.Framework = *v105
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedEvent_FrameworkRemoved(r randyMaster, easy bool) *Event_FrameworkRemoved {
	...
	v107 := mesos.NewPopulatedFrameworkInfo(r, easy)
	this.FrameworkInfo = *v107
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedEvent_AgentAdded(r randyMaster, easy bool) *Event_AgentAdded {
	...
	v108 := NewPopulatedResponse_GetAgents_Agent(r, easy)
	this.Agent = *v108
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedEvent_AgentRemoved(r randyMaster, easy bool) *Event_AgentRemoved {
	...
	v109 := mesos.NewPopulatedAgentID(r, easy)
	this.AgentID = *v109
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func randFieldMaster(dAtA []byte, r randyMaster, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateMaster(dAtA, uint64(v111))
	case 1:
		dAtA = encodeVarintPopulateMaster(dAtA, uint64(key))
...
func (this *Call_UpdateQuota) String() string {
	...
	s := strings.Join([]string{`&Call_UpdateQuota{`,
		`QuotaRequests:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.QuotaRequests), "QuotaRequest", "mesos_quota.QuotaRequest", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Call_UpdateQuota) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QuotaRequests", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.QuotaRequests = append(m.QuotaRequests, mesos_quota.QuotaRequest{})
			if err := m.QuotaRequests[len(m.QuotaRequests)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorMaster = []byte{
	...
	,
}
