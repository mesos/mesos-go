...
func NewPopulatedResponse_GetFlags(r randyAgent, easy bool) *Response_GetFlags {
	...
	if r.Intn(10) != 0 {
		...
		for i := 0; i < v9; i++ {
			v10 := mesos.NewPopulatedFlag(r, easy)
			this.Flags[i] = *v10
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedResponse_GetVersion(r randyAgent, easy bool) *Response_GetVersion {
	...
	v11 := mesos.NewPopulatedVersionInfo(r, easy)
	this.VersionInfo = *v11
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedResponse_GetMetrics(r randyAgent, easy bool) *Response_GetMetrics {
	...
	if r.Intn(10) != 0 {
		v12 := r.Intn(5)
		this.Metrics = make([]mesos.Metric, v12)
		for i := 0; i < v12; i++ {
			v13 := mesos.NewPopulatedMetric(r, easy)
			this.Metrics[i] = *v13
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedResponse_ListFiles(r randyAgent, easy bool) *Response_ListFiles {
	...
	if r.Intn(10) != 0 {
		v14 := r.Intn(5)
		this.FileInfos = make([]mesos.FileInfo, v14)
		for i := 0; i < v14; i++ {
			v15 := mesos.NewPopulatedFileInfo(r, easy)
			this.FileInfos[i] = *v15
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetContainers(r randyAgent, easy bool) *Response_GetContainers {
	...
	if r.Intn(10) == 0 {
		v17 := r.Intn(5)
		this.Containers = make([]Response_GetContainers_Container, v17)
		for i := 0; i < v17; i++ {
			v18 := NewPopulatedResponse_GetContainers_Container(r, easy)
			this.Containers[i] = *v18
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetContainers_Container(r randyAgent, easy bool) *Response_GetContainers_Container {
	...
	v19 := mesos.NewPopulatedFrameworkID(r, easy)
	this.FrameworkID = *v19
	v20 := mesos.NewPopulatedExecutorID(r, easy)
	this.ExecutorID = *v20
	this.ExecutorName = string(randStringAgent(r))
	v21 := mesos.NewPopulatedContainerID(r, easy)
...
func NewPopulatedResponse_GetFrameworks(r randyAgent, easy bool) *Response_GetFrameworks {
	...
	if r.Intn(10) != 0 {
		v22 := r.Intn(5)
		this.Frameworks = make([]Response_GetFrameworks_Framework, v22)
		for i := 0; i < v22; i++ {
			v23 := NewPopulatedResponse_GetFrameworks_Framework(r, easy)
			this.Frameworks[i] = *v23
		}
	}
	if r.Intn(10) != 0 {
		v24 := r.Intn(5)
		this.CompletedFrameworks = make([]Response_GetFrameworks_Framework, v24)
		for i := 0; i < v24; i++ {
			v25 := NewPopulatedResponse_GetFrameworks_Framework(r, easy)
			this.CompletedFrameworks[i] = *v25
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetFrameworks_Framework(r randyAgent, easy bool) *Response_GetFrameworks_Framework {
	...
	v26 := mesos.NewPopulatedFrameworkInfo(r, easy)
	this.FrameworkInfo = *v26
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedResponse_GetExecutors(r randyAgent, easy bool) *Response_GetExecutors {
	...
	if r.Intn(10) != 0 {
		v27 := r.Intn(5)
		this.Executors = make([]Response_GetExecutors_Executor, v27)
		for i := 0; i < v27; i++ {
			v28 := NewPopulatedResponse_GetExecutors_Executor(r, easy)
			this.Executors[i] = *v28
		}
	}
	if r.Intn(10) != 0 {
		v29 := r.Intn(5)
		this.CompletedExecutors = make([]Response_GetExecutors_Executor, v29)
		for i := 0; i < v29; i++ {
			v30 := NewPopulatedResponse_GetExecutors_Executor(r, easy)
			this.CompletedExecutors[i] = *v30
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetExecutors_Executor(r randyAgent, easy bool) *Response_GetExecutors_Executor {
	...
	v31 := mesos.NewPopulatedExecutorInfo(r, easy)
	this.ExecutorInfo = *v31
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedResponse_GetTasks(r randyAgent, easy bool) *Response_GetTasks {
	...
	if r.Intn(10) == 0 {
		v32 := r.Intn(5)
		this.PendingTasks = make([]mesos.Task, v32)
		for i := 0; i < v32; i++ {
			v33 := mesos.NewPopulatedTask(r, easy)
			this.PendingTasks[i] = *v33
		}
	}
	if r.Intn(10) == 0 {
		v34 := r.Intn(5)
		this.QueuedTasks = make([]mesos.Task, v34)
		for i := 0; i < v34; i++ {
			v35 := mesos.NewPopulatedTask(r, easy)
			this.QueuedTasks[i] = *v35
		}
	}
	if r.Intn(10) == 0 {
		v36 := r.Intn(5)
		this.LaunchedTasks = make([]mesos.Task, v36)
		for i := 0; i < v36; i++ {
			v37 := mesos.NewPopulatedTask(r, easy)
			this.LaunchedTasks[i] = *v37
		}
	}
	if r.Intn(10) == 0 {
		v38 := r.Intn(5)
		this.TerminatedTasks = make([]mesos.Task, v38)
		for i := 0; i < v38; i++ {
			v39 := mesos.NewPopulatedTask(r, easy)
			this.TerminatedTasks[i] = *v39
		}
	}
	if r.Intn(10) == 0 {
		v40 := r.Intn(5)
		this.CompletedTasks = make([]mesos.Task, v40)
		for i := 0; i < v40; i++ {
			v41 := mesos.NewPopulatedTask(r, easy)
			this.CompletedTasks[i] = *v41
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func randFieldAgent(dAtA []byte, r randyAgent, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateAgent(dAtA, uint64(v45))
	case 1:
		dAtA = encodeVarintPopulateAgent(dAtA, uint64(key))
...
var fileDescriptorAgent = []byte{
	...
	,
}
