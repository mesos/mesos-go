...
func serializeItem(pb proto.Message) ([]byte, error) {
  ...
  data, err := proto.Marshal(pb); if err != nil {
...
func (sdriver *SchedulerDriver) Init() error {
  ...
  dataObj, err := serialize(&sdriver.Framework); if err != nil {
    return err
  }
...
func (sdriver *SchedulerDriver) RequestResources(requests []Request) error {
  if (sdriver.driver != nil) {
    ...
    for _, request := range requests {
      requestItemData, err := serializeItem(&request); if err != nil {
        return err
      }
...
func (sdriver *SchedulerDriver) LaunchTasks(
  ...
  if (sdriver.driver != nil) {
    offerObj, err := serialize(offerId); if err != nil {
      return err
    }

    var tasksData []byte
    for _, task := range tasks {
      taskItemData, err := serializeItem(&task); if err != nil {
        return err
      }
    ...
    if (len(filters) > 1) {
      filtersObj, err := serialize(&filters[0]); if err != nil {
        return err
      }
...
func (sdriver *SchedulerDriver) KillTask(taskId *TaskID) error {
  if (sdriver.driver != nil) {
    message, err := serialize(taskId); if err != nil {
      return err
    }
...
func (sdriver *SchedulerDriver) DeclineOffer(
    ...
    filters... Filters) error {
  if (sdriver.driver != nil) {
    message, err := serialize(offerId); if err != nil {
      return err
    }
...
func resourceOffersCB(
  ...
  if (ptr != nil) {
    ...
    for i := 0; i < int(count); i++ {
      ...
      var offer Offer
      err := proto.Unmarshal(data, &offer); if err == nil {
...
func offerRescindedCB(ptr unsafe.Pointer, offerIdMessage *C.ProtobufObj) {
  if (ptr != nil) {
    ...
    var offerId OfferID
    err := proto.Unmarshal(data, &offerId); if err != nil {
      return
    }
...
func statusUpdateCB(
  ...
  if (ptr != nil) {
    ...
    err := proto.Unmarshal(data, &status); if err != nil {
...
func frameworkMessageCB(
  ...
  if (ptr != nil) {
    ...
    err := proto.Unmarshal(executorData, &executorId); if err != nil {
      return
    }

    slaveData := C.GoBytes(slaveIdMessage.data, C.int(slaveIdMessage.size))
    var slaveId SlaveID
    err = proto.Unmarshal(slaveData, &slaveId); if err != nil {
      return
    }
...
func slaveLostCB(ptr unsafe.Pointer, slaveIdMessage *C.ProtobufObj) {
  if (ptr != nil) {
    ...
    var slaveId SlaveID
    err := proto.Unmarshal(data, &slaveId); if err != nil {
      return
    }
