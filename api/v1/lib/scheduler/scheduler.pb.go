...
func NewPopulatedCall_Revive(r randyScheduler, easy bool) *Call_Revive {
	this := &Call_Revive{}
	if r.Intn(10) != 0 {
		v23 := string(randStringScheduler(r))
		this.Role = &v23
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedCall_Suppress(r randyScheduler, easy bool) *Call_Suppress {
	this := &Call_Suppress{}
	if r.Intn(10) != 0 {
		v38 := string(randStringScheduler(r))
		this.Role = &v38
	}
	if !easy && r.Intn(10) != 0 {
	}
...
var fileDescriptorScheduler = []byte{
	...
	,
