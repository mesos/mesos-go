...
func NewPopulatedResponse_GetFrameworks(r randyMaster, easy bool) *Response_GetFrameworks {
	...
	if r.Intn(10) != 0 {
		v63 := r.Intn(5)
		this.Frameworks = make([]Response_GetFrameworks_Framework, v63)
		for i := 0; i < v63; i++ {
			v64 := NewPopulatedResponse_GetFrameworks_Framework(r, easy)
			this.Frameworks[i] = *v64
		}
	}
	if r.Intn(10) != 0 {
		v65 := r.Intn(5)
		this.CompletedFrameworks = make([]Response_GetFrameworks_Framework, v65)
		for i := 0; i < v65; i++ {
			v66 := NewPopulatedResponse_GetFrameworks_Framework(r, easy)
			this.CompletedFrameworks[i] = *v66
		}
	}
	if r.Intn(10) != 0 {
		v67 := r.Intn(5)
		this.RecoveredFrameworks = make([]mesos.FrameworkInfo, v67)
		for i := 0; i < v67; i++ {
			v68 := mesos.NewPopulatedFrameworkInfo(r, easy)
			this.RecoveredFrameworks[i] = *v68
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetFrameworks_Framework(r randyMaster, easy bool) *Response_GetFrameworks_Framework {
	...
	if r.Intn(10) != 0 {
		v70 := r.Intn(5)
		this.Offers = make([]mesos.Offer, v70)
		for i := 0; i < v70; i++ {
			v71 := mesos.NewPopulatedOffer(r, easy)
			this.Offers[i] = *v71
		}
	}
	if r.Intn(10) != 0 {
		v72 := r.Intn(5)
		this.InverseOffers = make([]mesos.InverseOffer, v72)
		for i := 0; i < v72; i++ {
			v73 := mesos.NewPopulatedInverseOffer(r, easy)
			this.InverseOffers[i] = *v73
		}
	}
	if r.Intn(10) != 0 {
		v74 := r.Intn(5)
		this.AllocatedResources = make([]mesos.Resource, v74)
		for i := 0; i < v74; i++ {
			v75 := mesos.NewPopulatedResource(r, easy)
			this.AllocatedResources[i] = *v75
		}
	}
	if r.Intn(10) != 0 {
		v76 := r.Intn(5)
		this.OfferedResources = make([]mesos.Resource, v76)
		for i := 0; i < v76; i++ {
			v77 := mesos.NewPopulatedResource(r, easy)
			this.OfferedResources[i] = *v77
		}
	}
...
func NewPopulatedResponse_GetExecutors(r randyMaster, easy bool) *Response_GetExecutors {
	...
	if r.Intn(10) != 0 {
		v78 := r.Intn(5)
		this.Executors = make([]Response_GetExecutors_Executor, v78)
		for i := 0; i < v78; i++ {
			v79 := NewPopulatedResponse_GetExecutors_Executor(r, easy)
			this.Executors[i] = *v79
		}
	}
	if r.Intn(10) != 0 {
		v80 := r.Intn(5)
		this.OrphanExecutors = make([]Response_GetExecutors_Executor, v80)
		for i := 0; i < v80; i++ {
			v81 := NewPopulatedResponse_GetExecutors_Executor(r, easy)
			this.OrphanExecutors[i] = *v81
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetExecutors_Executor(r randyMaster, easy bool) *Response_GetExecutors_Executor {
	...
	v82 := mesos.NewPopulatedExecutorInfo(r, easy)
	this.ExecutorInfo = *v82
	v83 := mesos.NewPopulatedAgentID(r, easy)
	this.AgentID = *v83
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedResponse_GetOperations(r randyMaster, easy bool) *Response_GetOperations {
	...
	if r.Intn(10) != 0 {
		v84 := r.Intn(5)
		this.Operations = make([]mesos.Operation, v84)
		for i := 0; i < v84; i++ {
			v85 := mesos.NewPopulatedOperation(r, easy)
			this.Operations[i] = *v85
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetTasks(r randyMaster, easy bool) *Response_GetTasks {
	...
	if r.Intn(10) == 0 {
		v86 := r.Intn(5)
		this.PendingTasks = make([]mesos.Task, v86)
		for i := 0; i < v86; i++ {
			v87 := mesos.NewPopulatedTask(r, easy)
			this.PendingTasks[i] = *v87
		}
	}
	if r.Intn(10) == 0 {
		v88 := r.Intn(5)
		this.Tasks = make([]mesos.Task, v88)
		for i := 0; i < v88; i++ {
	...
	if r.Intn(10) == 0 {
		v90 := r.Intn(5)
		this.CompletedTasks = make([]mesos.Task, v90)
		for i := 0; i < v90; i++ {
			v91 := mesos.NewPopulatedTask(r, easy)
			this.CompletedTasks[i] = *v91
		}
	}
	if r.Intn(10) == 0 {
		v92 := r.Intn(5)
		this.OrphanTasks = make([]mesos.Task, v92)
		for i := 0; i < v92; i++ {
			v93 := mesos.NewPopulatedTask(r, easy)
			this.OrphanTasks[i] = *v93
		}
	}
	if r.Intn(10) == 0 {
		v94 := r.Intn(5)
		this.UnreachableTasks = make([]mesos.Task, v94)
		for i := 0; i < v94; i++ {
			v95 := mesos.NewPopulatedTask(r, easy)
			this.UnreachableTasks[i] = *v95
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetRoles(r randyMaster, easy bool) *Response_GetRoles {
	...
	if r.Intn(10) != 0 {
		v96 := r.Intn(5)
		this.Roles = make([]mesos.Role, v96)
		for i := 0; i < v96; i++ {
			v97 := mesos.NewPopulatedRole(r, easy)
			this.Roles[i] = *v97
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedResponse_GetWeights(r randyMaster, easy bool) *Response_GetWeights {
	...
	if r.Intn(10) != 0 {
		v98 := r.Intn(5)
		this.WeightInfos = make([]mesos.WeightInfo, v98)
		for i := 0; i < v98; i++ {
			v99 := mesos.NewPopulatedWeightInfo(r, easy)
			this.WeightInfos[i] = *v99
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedResponse_GetMaintenanceStatus(r randyMaster, easy bool) *Response_GetMaintenanceStatus {
	...
	v102 := mesos_maintenance.NewPopulatedClusterStatus(r, easy)
	this.Status = *v102
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedResponse_GetMaintenanceSchedule(r randyMaster, easy bool) *Response_GetMaintenanceSchedule {
	...
	v103 := mesos_maintenance.NewPopulatedSchedule(r, easy)
	this.Schedule = *v103
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedResponse_GetQuota(r randyMaster, easy bool) *Response_GetQuota {
	...
	v104 := mesos_quota.NewPopulatedQuotaStatus(r, easy)
	this.Status = *v104
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedEvent_Subscribed(r randyMaster, easy bool) *Event_Subscribed {
	...
	if r.Intn(10) != 0 {
		...
		this.HeartbeatIntervalSeconds = &v105
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedEvent_TaskAdded(r randyMaster, easy bool) *Event_TaskAdded {
	...
	v106 := mesos.NewPopulatedTask(r, easy)
	this.Task = *v106
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedEvent_TaskUpdated(r randyMaster, easy bool) *Event_TaskUpdated {
	...
	v107 := mesos.NewPopulatedFrameworkID(r, easy)
	this.FrameworkID = *v107
	v108 := mesos.NewPopulatedTaskStatus(r, easy)
	this.Status = *v108
	v109 := mesos.TaskState([]int32{6, 0, 1, 8, 2, 3, 4, 7, 5, 9, 10, 11, 12, 13}[r.Intn(14)])
	this.State = &v109
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedEvent_FrameworkAdded(r randyMaster, easy bool) *Event_FrameworkAdded {
	...
	v110 := NewPopulatedResponse_GetFrameworks_Framework(r, easy)
	this.Framework = *v110
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedEvent_FrameworkRemoved(r randyMaster, easy bool) *Event_FrameworkRemoved {
	...
	v112 := mesos.NewPopulatedFrameworkInfo(r, easy)
	this.FrameworkInfo = *v112
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedEvent_AgentAdded(r randyMaster, easy bool) *Event_AgentAdded {
	...
	v113 := NewPopulatedResponse_GetAgents_Agent(r, easy)
	this.Agent = *v113
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedEvent_AgentRemoved(r randyMaster, easy bool) *Event_AgentRemoved {
	...
	v114 := mesos.NewPopulatedAgentID(r, easy)
	this.AgentID = *v114
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func randFieldMaster(dAtA []byte, r randyMaster, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateMaster(dAtA, uint64(v116))
	case 1:
		dAtA = encodeVarintPopulateMaster(dAtA, uint64(key))
...
var fileDescriptorMaster = []byte{
	...
	0x63, 0xcf, 0x0c, 0x1c, 0x77, 0xc8, 0xd1, 0xda, 0x6f, 0xdb, 0x4e, 0x70, 0x3e, 0x3e, 0xdb, 0xec,
	0xba, 0x83, 0x2d, 0xa6, 0xc8, 0xff, 0xde, 0xb7, 0xdd, 0x2d, 0x73, 0xe4, 0x6c, 0x5d, 0x7c, 0xb8,
	...
	,
	...
	,
	...
	,
