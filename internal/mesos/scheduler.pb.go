...
func (this *Event) GoString() string {
	...
	s := make([]string, 0, 12)
	s = append(s, "&mesos.Event{")
	if this.Type != nil {
		s = append(s, "Type: "+valueToGoStringScheduler(this.Type, "mesos.Event_Type")+",\n")
	}
...
func (this *Event_Subscribed) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&mesos.Event_Subscribed{")
...
func (this *Event_Rescind) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&mesos.Event_Rescind{")
	if this.OfferId != nil {
...
func (this *Event_Message) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&mesos.Event_Message{")
	if this.AgentId != nil {
...
func (this *Event_Failure) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&mesos.Event_Failure{")
	if this.AgentId != nil {
		s = append(s, "AgentId: "+fmt.Sprintf("%#v", this.AgentId)+",\n")
	}
	if this.ExecutorId != nil {
...
func (this *Call) GoString() string {
	...
	s := make([]string, 0, 15)
	s = append(s, "&mesos.Call{")
	if this.FrameworkId != nil {
		s = append(s, "FrameworkId: "+fmt.Sprintf("%#v", this.FrameworkId)+",\n")
	}
	if this.Type != nil {
		s = append(s, "Type: "+valueToGoStringScheduler(this.Type, "mesos.Call_Type")+",\n")
	}
...
func (this *Call_Subscribe) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&mesos.Call_Subscribe{")
...
func (this *Call_Shutdown) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&mesos.Call_Shutdown{")
	if this.ExecutorId != nil {
		s = append(s, "ExecutorId: "+fmt.Sprintf("%#v", this.ExecutorId)+",\n")
	}
	if this.AgentId != nil {
...
func (this *Call_Acknowledge) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&mesos.Call_Acknowledge{")
	if this.AgentId != nil {
		s = append(s, "AgentId: "+fmt.Sprintf("%#v", this.AgentId)+",\n")
	}
	if this.TaskId != nil {
...
func (this *Call_Reconcile_Task) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&mesos.Call_Reconcile_Task{")
	if this.TaskId != nil {
		s = append(s, "TaskId: "+fmt.Sprintf("%#v", this.TaskId)+",\n")
	}
	if this.AgentId != nil {
...
func NewPopulatedCall_Accept(r randyScheduler, easy bool) *Call_Accept {
	...
	if r.Intn(10) != 0 {
		v10 := r.Intn(10)
		this.OfferIds = make([]*OfferID, v10)
		for i := 0; i < v10; i++ {
	...
	if r.Intn(10) != 0 {
		v11 := r.Intn(10)
		this.Operations = make([]*Offer_Operation, v11)
		for i := 0; i < v11; i++ {
...
func NewPopulatedCall_Decline(r randyScheduler, easy bool) *Call_Decline {
	...
	if r.Intn(10) != 0 {
		v12 := r.Intn(10)
		this.OfferIds = make([]*OfferID, v12)
		for i := 0; i < v12; i++ {
			this.OfferIds[i] = NewPopulatedOfferID(r, easy)
		}
	}
...
func NewPopulatedCall_Request(r randyScheduler, easy bool) *Call_Request {
	...
	if r.Intn(10) != 0 {
		v16 := r.Intn(10)
		this.Requests = make([]*Request, v16)
		for i := 0; i < v16; i++ {
